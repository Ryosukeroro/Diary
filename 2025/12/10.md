...
最適負荷ってパラメータがある。エンドミルの直径×0.4がデフォルトらしい。×0.35かな...
...
ROSのmapデータ作ろうとしました。どうするのが最適なのか...Pythonで書くのがいいのか...?

前刷り作成

texで始めたぜ！Gitもやってます！NASとも連携！まずは参考文献かな自分は、大衆受けで一応タイトル埋めるか

ロボコン用作成

気ままにやるか。フィールド読み込ませかな。俺の廊下のデータでええや
